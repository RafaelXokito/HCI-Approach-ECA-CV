...
\begin{itemize}
	...
	\item Proposal of an architecture of an HCI approach aided with MER, through computer vision, sentiment analysis a fusion method, and emphatic conversational agent powered with a LLM.
\end{itemize}
