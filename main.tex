...
% Its expected that the fusion method gives more relevance to some data then to other. Because some will be more reliable than other, but the expectations is all as one result in better results. 
